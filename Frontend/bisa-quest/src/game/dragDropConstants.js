...
// Generated item images (AI)
import SandokNewImg from "../assets/items/sandok_new.png";
import KalderoNewImg from "../assets/items/kaldero_new.png";
import UnanNewImg from "../assets/items/unan_new.png";
import BinhiNewImg from "../assets/items/binhi_new.png";

// Generated item images (Batch 3)
import KutsaraNewImg from "../assets/items/kutsara_new.png";
import TinidorNewImg from "../assets/items/tinidor_new.png";
import BasoNewImg from "../assets/items/baso_new.png";
import KamatisNewImg from "../assets/items/kamatis_new.png";
import TalongNewImg from "../assets/items/talong_new.png";
import KalabasaNewImg from "../assets/items/kalabasa_new.png";
import SibuyasNewImg from "../assets/items/sibuyas_new.png";
import AhosNewImg from "../assets/items/ahos_new.png";
import KamoteNewImg from "../assets/items/kamote_new.png";
...
export const ITEM_IMAGE_MAP = {
  ...
  // Generated (new quests)
  sandok_new: SandokNewImg,
  kaldero_new: KalderoNewImg,
  unan_new: UnanNewImg,
  binhi_new: BinhiNewImg,

  // Generated (Batch 3)
  kutsara_new: KutsaraNewImg,
  tinidor_new: TinidorNewImg,
  baso_new: BasoNewImg,
  kamatis_new: KamatisNewImg,
  talong_new: TalongNewImg,
  kalabasa_new: KalabasaNewImg,
  sibuyas_new: SibuyasNewImg,
  ahos_new: AhosNewImg,
  kamote_new: KamoteNewImg,
};
