...
const ITEM_QUESTS = {
    ...
    aparador: {
        ...
        successText: "Nahinlo na ang mga sanina!",
        draggableItems: [
    ...
    drumin: {
        ...
        instructionBisaya: "Punoa ang baril og tubig!",
    ...
    lamesa_kitchen: {
        ...
        successText: "Andam na ang mga gamit!",
        draggableItems: [
            { id: "dz_kplate", imageKey: "plato", label: "Plato/Plate", startX: 80, startY: 78 },
            { id: "dz_kcup", imageKey: "tasa", label: "Tasa/Cup", startX: 75, startY: 40 },
            { id: "dz_kladle", imageKey: "sandok", label: "Luwag/Ladle", startX: 12, startY: 80 },
        ],
        dropZone: { x: 18, y: 40, w: 28, h: 22, emoji: "🍽️", label: "Lamesa/Table" },
    },
    estante_wala: {
        mechanic: "drag_to_zone",
        background: AssetManifest.village.scenarios.kitchen,
        instructionBisaya: "Ibutang ang mga gamit sa estante!",
        instructionEnglish: "Put the kitchen wares on the shelves!",
        successText: "Nahipos na!",
        draggableItems: [
            { id: "dz_eplate", imageKey: "plato", label: "Plato/Plate", startX: 35, startY: 78, size: 100 },
            { id: "dz_ecup", imageKey: "tasa", label: "Tasa/Cup", startX: 50, startY: 82, size: 80  },
            { id: "dz_epot", imageKey: "kaldero", label: "Kaldero/Pot", startX: 75, startY: 75, size: 200   },
        ],
    ...
    basket_kitchen: {
        ...
        successText: "Nahipos na ang mga utanon!",
        draggableItems: [
            { id: "dz_carrot", imageKey: "carrot", label: "Karot/Carrot", startX: 12, startY: 70, size: 200 },
            { id: "dz_potato", imageKey: "potato", label: "Patatas/Potato", startX: 92, startY: 35, size: 180 },
            { id: "dz_onion", imageKey: "onion", label: "Sibuyas/Onion", startX: 90, startY: 78, size: 150 },
        ],
        dropZone: { x: 25, y: 25, w: 50, h: 50, emoji: "🧺", label: "Bukag/Basket" },
    },
    estante_tuo: {
        mechanic: "drag_to_zone",
        background: AssetManifest.village.scenarios.kitchen,
        ...
        draggableItems: [
            { id: "dz_tpot", imageKey: "kaldero", label: "Kaldero/Pot", startX: 30, startY: 78, size: 180 },
            { id: "dz_tpan", imageKey: "kawali", label: "Kaha/Frying Pan", startX: 45, startY: 80, size: 160  },
        ],
    ...
    katre: {
        ...
        successText: "Tarong na ang katre!",
        draggableItems: [
            { id: "dz_pillow", imageKey: "pillow", label: "Unan/Pillow", startX: 25, startY: 78, size: 140 },
            { id: "dz_habol", imageKey: "habol", label: "Habol/Blanket", startX: 70, startY: 80, size: 200 },
            ],
    ...
    aparador_bedroom: {
        ...
        instructionBisaya: "Ibutang ang sinina sa aparador!",
        instructionEnglish: "Put the clothes in the cabinet!",
        successText: "Nahinlo na ang mga gamit!",
        draggableItems: [
            { id: "dz_adress", imageKey: "dress", label: "Bistida/Dress", startX: 28, startY: 75, size: 180 },
            { id: "dz_atowel", imageKey: "towel", label: "Toalya/Towel", startX: 52, startY: 82, size: 110  },
            { id: "dz_ashoes", imageKey: "shoes", label: "Sapatos/Shoes", startX: 75, startY: 78, size: 110  },
        ],
        dropZone: { x: 61, y: 50, w: 14, h: 22, emoji: "🗄️", label: "Aparador/Cabinet" },
    },
    bentilador_bedroom: {
        mechanic: "fan_speed",
    ...
    bukag_bedroom: {
        ...
        draggableItems: [
            { id: "dz_lshirt", imageKey: "baro", label: "Baro/Shirt", startX: 30, startY: 40, size: 150 },
            { id: "dz_lpants", imageKey: "sinina", label: "Sinina/Pants", startX: 55, startY: 35, size: 180 },
            { id: "dz_ltowel", imageKey: "towel", label: "Toalya/Towel", startX: 40, startY: 78, size: 100 },
        ],
    ...
    bintana_bedroom: {
        ...
        wipeStage: {
            ...
            successLabel: "Limpyo na!",
            successBisaya: "Wala nay abog ang bintana! Maayo kaayo! 🎉",
            successEnglish: "The window is dustless now! Well done! 🎉",
