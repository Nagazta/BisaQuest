...
const ITEM_QUESTS = {
    ...
    bookshelf: {
        mechanic: "drag_drop",
        instructionBisaya: "I-drag ang mga libro sa estante!",
        instructionEnglish: "Drag the books to the shelf!",
        items: [
            { id: "book_1", label: "Libro", imageKey: "book", isCorrect: true, correctZone: "bookshelf" },
            { id: "book_2", label: "Libro", imageKey: "book", isCorrect: true, correctZone: "bookshelf" },
            { id: "book_3", label: "Libro", imageKey: "book", isCorrect: true, correctZone: "bookshelf" },
        ],
        zones: [
            { id: "bookshelf", label: "Estante / Shelf" },
            { id: "lamesa", label: "Lamesa / Table" },
        ],
    },
